            ...
            {!revealed ? (
              ...
              >
                ...
                <motion.div
                  ...
                  className="flex items-center gap-3 mb-5 rounded-xl p-1.5"
                  style={{ backgroundColor: '#f4faf9', border: `2px dashed ${TEAL}55` }}
                >
                  <div className="flex-1 px-4 py-3 text-center">
                    <span
                      className="font-mono text-xl tracking-[0.35em] font-bold"
                      style={{ color: NAVY }}
                    >
                      {brand.code}
                    </span>
                  ...
                  <button
                    onClick={handleCopy}
                    className="shrink-0 flex items-center gap-1.5 px-5 py-3 rounded-lg text-xs font-semibold uppercase tracking-widest text-white transition-all duration-200"
            ...
            <div className="flex flex-col lg:flex-row lg:items-end gap-6 w-full">
              ...
              <div>
                ...
                >
                  ...
                  {brand.verified && (
                    <span
                      className="flex items-center gap-1 px-3 py-1 rounded-full text-[10px] uppercase tracking-wider font-semibold"
